...
var Piston = exports.Piston = function (_React$Component) {
  ...
  (0, _createClass3.default)(Piston, [{
    ...
    value: function render() {
      ...
      var r = _shinkansenGears.Gears.engage(reverse, pattern);
      var f = _shinkansenGears.Gears.engage(forward, pattern);

      if (r || f) {
        return _react2.default.createElement(
          'ul',
          { className: 'shinkansen-piston', key: 'shinkansen-piston' },
          r ? _react2.default.createElement(_reverse.Reverse, { pathname: _shinkansenGears.Gears.path(reverse, pattern) }) : false,
          f ? _react2.default.createElement(_forward.Forward, { pathname: _shinkansenGears.Gears.path(forward, pattern) }) : false
        );
      }
...
Piston.defaultProps = {
  pattern: _shinkansenGears.Gears.pattern()
};
