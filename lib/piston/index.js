...
var Piston = exports.Piston = function (_React$Component) {
  ...
  (0, _createClass3.default)(Piston, [{
    ...
    value: function render() {
      ...
      var r = _locomotiveGears.Gears.engage(reverse, pattern);
      var f = _locomotiveGears.Gears.engage(forward, pattern);

      if (r || f) {
        return _react2.default.createElement(
          'ul',
          { className: 'locomotive-piston', key: 'locomotive-piston' },
          r ? _react2.default.createElement(_reverse.Reverse, { pathname: _locomotiveGears.Gears.path(reverse, pattern) }) : false,
          f ? _react2.default.createElement(_forward.Forward, { pathname: _locomotiveGears.Gears.path(forward, pattern) }) : false
        );
      }
...
Piston.defaultProps = {
  pattern: _locomotiveGears.Gears.pattern()
};
