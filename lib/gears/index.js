...
var Gears = exports.Gears = function (_React$Component) {
  _inherits(Gears, _React$Component);
  ...
  function Gears() {
    ...
    _classCallCheck(this, Gears);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Gears.__proto__ || Object.getPrototypeOf(Gears)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
  }
